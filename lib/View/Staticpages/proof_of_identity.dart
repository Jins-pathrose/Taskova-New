...
//                       // Main explanation
//                       const Text(
//                         'To ensure the safety, trust, and reliability of the Taskova platform, we require all drivers to provide a valid Proof of Identity. This step is essential to verify that you are who you say you are and to comply with legal and safety standards.',
//                         style: TextStyle(
//                           fontSize: 16,
//                           height: 1.6,
//                           color: textPrimary,
...
//                         'Protects both drivers and customers',
//                         successGreen,
//                       ),
//                       const SizedBox(height: 12),
//                       _buildBenefitItem(
...
//                       _buildDocumentItem('UK Driving Licence'),
//                       _buildDocumentItem('EU/EEA Passport'),
//                       _buildDocumentItem('Biometric Residence Permit'),
//                       _buildDocumentItem('National Identity Card (EU/EEA)'),
//                     ],
//                   ),
//                 ),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Professional title
                Text(
                  appLanguage.get('Proof_of_Identity_Required'),
                  style: const TextStyle(
                    fontSize: 28,
                    fontWeight: FontWeight.w700,
                    color: textPrimary,
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Main explanation
                      Text(
                        appLanguage.get('To_ensure_the_safety_trust_and_reliability_of_the_Taskova_platform_we_require_all_drivers_to_provide_a_valid_Proof_of_Identity_This_step_is_essential_to_verify_that_you_are_who_you_say_you_are_and_to_comply_with_legal_and_safety_standards'),
                        style: const TextStyle(
                          fontSize: 16,
                          height: 1.6,
                          color: textPrimary,
                      ...
                      _buildBenefitItem(
                        CupertinoIcons.checkmark_seal_fill,
                        appLanguage.get('Verifies_your_identity_securely'),
                        successGreen,
                      ),
                      const SizedBox(height: 12),
                      _buildBenefitItem(
                        CupertinoIcons.shield_fill,
                        appLanguage.get('Protects_both_drivers_and_customers'),
                        successGreen,
                      ),
                      const SizedBox(height: 12),
                      _buildBenefitItem(
                        CupertinoIcons.lock_fill,
                        appLanguage.get('Prevents_fraudulent_activity'),
                        successGreen,
                      ),
                    ],
                  ),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildDocumentItem(appLanguage.get('UK_Driving_Licence')),
                      _buildDocumentItem(appLanguage.get('EU_EEA_Passport')),
                      _buildDocumentItem(appLanguage.get('Biometric_Residence_Permit')),
                      _buildDocumentItem(appLanguage.get('National_Identity_Card_EU_EEA')),
                    ],
                  ),
                ),
