...
import 'package:taskova_new/View/Language/language_provider.dart';
import 'package:taskova_new/View/appliedjobs.dart';
import 'package:taskova_new/stripetest.dart';
 ...
 Future<void> _loadProfileData() async {
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        _nameController.text = data['name'] ?? '';
        // Do not overwrite email from SharedPreferences
        _phoneController.text = data['phone_number'] ?? '';
        _selectedAddress = data['preferred_working_address'] ?? '';
        _addressController.text = _selectedAddress ?? '';
      ...
      // Even if API fails, keep SharedPreferences email
      setState(() {
...
SizedBox(height: 16),
    ...
    //             child: Row(
    //               children: [
    //                 Icon(CupertinoIcons.time, color: primaryBlue),
    //                 SizedBox(width: 12),
    //                 Expanded(
    //                   child: Text(
    //                     _drivingDurationController.text.isEmpty
    //                         ? appLanguage.get('select_driving_duration')
    //                         : _drivingDurationOptions.firstWhere(
    //                             (option) =>
    //                                 option['value'] ==
    //                                 _drivingDurationController.text,
    //                             orElse: () => {'label': 'Select duration'})['label']!,
    //                     style: TextStyle(
    //                       color: _drivingDurationController.text.isEmpty
    ...
    //                 title: Text(appLanguage.get('driving_duration')),
    ...
    //                         onPressed: () {
    //                           setState(() {
    //                             _drivingDurationController.text = option['value']!;
    //                           });
    //                           Navigator.pop(context);
    //                         },
    //                       ),
    ...
    //       )
    //     : _buildFormField(
    //         controller: _drivingDurationController,
    //         placeholder: appLanguage.get('driving_duration'),
    //         icon: CupertinoIcons.time,
    //         readOnly: true,
    //         validator: (value) {
    //           if (value == null || value.isEmpty) {
    //             return appLanguage.get('please_select_driving_duration');
    //           }
    //           return null;
    //         },
    //       ),
